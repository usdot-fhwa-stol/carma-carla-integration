...
setup(
    name=package_name,
    version='0.0.0',
    packages=find_packages(where='src', include=['carma_carla_bridge', 'carma_carla_bridge.*']),
    package_dir={'': 'src'},
    data_files=[
    ...
    entry_points={
        'console_scripts': [
            ...
            'carla_to_carma_sensor_external_objects = carma_carla_bridge.carla_to_carma_sensor_external_objects:main',
