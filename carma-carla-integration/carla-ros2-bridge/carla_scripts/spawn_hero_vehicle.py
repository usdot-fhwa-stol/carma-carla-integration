...
# Spawns in a hero vehicle with sensors and info from stack.json, publishes all info to ROS2 
# View info with ros2 topic list / view
# python3 spawn_vehicle.py --file stack.json
...
def _setup_sensors(world, vehicle, sensors_config):
    ...
    for sensor in sensors_config:
        ...
        print(f"[DEBUG] Trying to load sensor type: {sensor.get('type')}")
        ...
        print(f"[DEBUG] Loaded in sensor type: {sensor.get('type')}")
    return sensors
