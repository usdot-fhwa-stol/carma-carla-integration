...
BLOCK
  ...
  carma-carla-integration_$i:
    ...
    environment:
      - ROS_IP=172.$(($i+2)).0.4
      - ROS_MASTER_URI=http://172.$(($i+2)).0.2:11311/
    command: bash -c "export PYTHONPATH=/home/carma_carla_ws/devel/lib/python2.7/dist-packages:/opt/ros/kinetic/lib/python2.7/dist-packages:/home/PythonAPI/carla/dist/carla-0.9.15-py2.7-linux-x86_64.egg &&
