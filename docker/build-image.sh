...
echo ""
echo "##### $IMAGE ROS 2 Docker Image Build Script #####"
echo ""
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -d|--develop)
            ...
            COMPONENT_VERSION_STRING=develop-ros2
            shift ;;
        *)
            shift ;;
    esac
...
echo "Building ROS 2 docker image for $IMAGE version: $COMPONENT_VERSION_STRING"
echo "Final image name: $USERNAME/$IMAGE:$COMPONENT_VERSION_STRING"

cd ..
if [[ $COMPONENT_VERSION_STRING = "develop-ros2" ]]; then
...
echo ""
echo "##### ROS 2 Docker Image Build Complete! #####"
