...
sudo python3 -m pip install simple-pid==1.0.1 wheel numpy transforms3d
sudo update-alternatives --install /usr/bin/python python /usr/bin/python3 10

# Clone CARLA ROS bridge
git clone --depth 1 -b master --recurse-submodules https://github.com/carla-simulator/ros-bridge.git
